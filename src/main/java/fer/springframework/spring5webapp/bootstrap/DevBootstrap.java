package fer.springframework.spring5webapp.bootstrap;

import fer.springframework.spring5webapp.model.Author;
import fer.springframework.spring5webapp.model.Book;
...
import fer.springframework.spring5webapp.repositories.PublisherRepository;
...
public class DevBootstrap implements ApplicationListener<ContextRefreshedEvent>{
    ...
    private void initData(){
        ...
        Book noEJB = new Book( "J2EE Without EJB", "234444", publisher);
